...
def test_calculate_beverage_eta_multibartender_no_orders(multi_scheduler):
    ...
    beverage_eta, bartender_idx = calculate_beverage_eta_multibartender(2, current_time, multi_scheduler)
...
def test_calculate_overall_eta_beverage_less_than_food(multi_scheduler):
    ...
    overall_eta = calculate_overall_eta(3, 1, current_time, multi_scheduler)
...
def test_calculate_overall_eta_beverage_greater(multi_scheduler):
    ...
    multi_scheduler.schedulers[0].add_order(0, 10)
    multi_scheduler.schedulers[1].add_order(0, 10)
    ...
    overall_eta = calculate_overall_eta(1, 10, current_time, multi_scheduler)
