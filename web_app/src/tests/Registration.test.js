...
describe('Registration Component', () => {
  ...
  test('shows error if phone number is not exactly 10 digits', async () => {
    ...
    expect(toast.error).toHaveBeenCalledWith("Phone number must be exactly 10 digits.");
  });
  ...
  test('shows error when registration fails without response data', async () => {
    ...
    expect(toast.error).toHaveBeenCalledWith("Registration failed: Network Error");
  });
